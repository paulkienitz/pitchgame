...
//       searchable pitches!  with star level filter
//       support sso identity, and use for teams and admin... or simple password if that's too hard? or local pwd as max security?
...
if (isset($_POST['formtype']) && !$databaseFailed)      // extract form values, validate, and update
{
    ...
    else if ($_POST['formtype'] == 'name')              // GETNAME form submitted
    {
